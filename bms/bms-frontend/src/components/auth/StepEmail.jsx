  ...
  return (
    <div className="flex flex-col gap-3 px-10 py-6">
      ...
      <button
        ...
        disabled={otpLoader}
        className="w-full cursor-pointer text-white bg-black py-3 rounded-md text-lg hover:bg-gray-800 transition flex justify-center items-center"
      >
        {otpLoader ? <HashLoader size={20} color="white" /> : "Continue"}
      </button>
